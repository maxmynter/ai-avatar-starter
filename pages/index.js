...
const Home = () => {
  ...
  const generateAction = async () => {
    ...
    const finalInput = input.replace(/max/, "maxmynter");
      ...
      <div className="container">
        <div className="header">
          ...
          <div className="header-subtitle">
            <h2>
              Turn me into anyone you want. Just include maxmynter in the
              prompt.
            </h2>
          </div>
          <div className="prompt-container">
            <input className="prompt-box" value={input} onChange={typeInput} />
